...
class Ui_PropertyWindow(object):
    def setupUi(self, PropertyWindow):
        ...
        self.cb_datatype.addItem("Boolean")
        self.cb_datatype.addItem("Character")
        self.cb_datatype.addItem("Integer")
        self.cb_datatype.addItem("Real")
        self.cb_datatype.addItem("String")
        self.cb_datatype.addItem("Time")
