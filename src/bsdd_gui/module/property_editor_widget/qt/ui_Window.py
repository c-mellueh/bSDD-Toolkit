...
class Ui_PropertyWindow(object):
    def setupUi(self, PropertyWindow):
        ...
        self.cb_datatype.addItem(u"Boolean")
        self.cb_datatype.addItem(u"Character")
        self.cb_datatype.addItem(u"Integer")
        self.cb_datatype.addItem(u"Real")
        self.cb_datatype.addItem(u"String")
        self.cb_datatype.addItem(u"Time")
        ...
        sizePolicy3.setHeightForWidth(self.pb_new_value.sizePolicy().hasHeightForWidth())
        self.pb_new_value.setSizePolicy(sizePolicy3)
        ...
        self.bt_version_control.setObjectName(u"bt_version_control")
        ...
        self.lb_dimension.setObjectName(u"lb_dimension")
...
"                                                                \"SpecialWidth\".", None))
        ...
        self.bt_version_control.setTitle(QCoreApplication.translate("PropertyWindow", u"Version Control", None))
        ...
        self.lb_revision_number.setText(QCoreApplication.translate("PropertyWindow", u"Revision Number:", None))
        ...
        self.lb_deprecation_explanation.setText(QCoreApplication.translate("PropertyWindow", u"DeprecationExplanation", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_relations), QCoreApplication.translate("PropertyWindow", u"Relations & + Version", None))
        self.groupBox.setTitle(QCoreApplication.translate("PropertyWindow", u"Identification", None))
#if QT_CONFIG(tooltip)
        ...
        self.label.setText(QCoreApplication.translate("PropertyWindow", u"OwnedUri:", None))
#if QT_CONFIG(tooltip)
...
"                                            enough.", None))
        ...
        self.lb_dimension.setText(QCoreApplication.translate("PropertyWindow", u"Dimension:", None))
        self.gb_language.setTitle(QCoreApplication.translate("PropertyWindow", u"Language", None))
#if QT_CONFIG(tooltip)
