...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.cb_character.addItem("")
        self.cb_character.setObjectName("cb_character")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_17.setText(QCoreApplication.translate("Form", "String", None))
        self.label_16.setText(QCoreApplication.translate("Form", "**Datatype Mapping**", None))
        self.label_18.setText(QCoreApplication.translate("Form", "Boolean", None))
        self.label_20.setText(QCoreApplication.translate("Form", "Real", None))
        self.label_21.setText(QCoreApplication.translate("Form", "Character", None))
        self.label_19.setText(QCoreApplication.translate("Form", "Integer", None))
        self.label_22.setText(QCoreApplication.translate("Form", "Time", None))
        self.cb_string.setItemText(0, QCoreApplication.translate("Form", "IFCTEXT", None))
        self.cb_string.setItemText(1, QCoreApplication.translate("Form", "IFCLABEL", None))

        self.cb_boolean.setItemText(0, QCoreApplication.translate("Form", "IFCBOOLEAN", None))

        self.cb_integer.setItemText(0, QCoreApplication.translate("Form", "IFCINTEGER", None))

        self.cb_real.setItemText(0, QCoreApplication.translate("Form", "IFCREAL", None))

        self.cb_character.setItemText(0, QCoreApplication.translate("Form", "IFCTEXT", None))
        self.cb_character.setItemText(1, QCoreApplication.translate("Form", "IFCLABEL", None))

        self.cb_time.setItemText(0, QCoreApplication.translate("Form", "IFCDATETIME", None))

        # if QT_CONFIG(tooltip)
        self.pb_import.setToolTip(QCoreApplication.translate("Form", "Import Settings", None))
        # endif // QT_CONFIG(tooltip)
        self.pb_import.setText("")
        # if QT_CONFIG(tooltip)
        self.pb_export.setToolTip(QCoreApplication.translate("Form", "Export Settings", None))
        # endif // QT_CONFIG(tooltip)
