...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tv_class.setDragEnabled(True)
        self.tv_class.setDragDropOverwriteMode(True)
        self.tv_class.setDragDropMode(QAbstractItemView.DragDropMode.DragDrop)
        self.tv_class.setDefaultDropAction(Qt.DropAction.MoveAction)
        ...
        self.lb_prop.setObjectName("lb_prop")
    ...
    def retranslateUi(self, Form):
        ...
        self.lb_prop.setText(QCoreApplication.translate("Form", "Property:", None))
