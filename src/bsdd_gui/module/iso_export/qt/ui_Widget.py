...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", "Format:", None))
        self.cb_format.setItemText(0, QCoreApplication.translate("Form", "ISO 23386 XML", None))
        self.cb_format.setItemText(
            1, QCoreApplication.translate("Form", "ISO 7817-3 XML (LOIN)", None)
        )
