...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.bt_tree.setObjectName(u"bt_tree")

        self.gridLayout.addWidget(self.bt_tree, 4, 0, 1, 1)

        self.bt_export_html = QPushButton(Form)
        self.bt_export_html.setObjectName(u"bt_export_html")

        self.gridLayout.addWidget(self.bt_export_html, 4, 1, 1, 1)

        self.bt_export_html_tabs = QPushButton(Form)
        self.bt_export_html_tabs.setObjectName(u"bt_export_html_tabs")

        self.gridLayout.addWidget(self.bt_export_html_tabs, 5, 0, 1, 2)
    ...
    def retranslateUi(self, Form):
        ...
        self.bt_load.setText(QCoreApplication.translate("Form", u"Load All", None))
        ...
        self.bt_start_stop.setText(QCoreApplication.translate("Form", u"Pause", None))
        self.bt_clear.setText(QCoreApplication.translate("Form", u"Clear", None))
        self.bt_tree.setText(QCoreApplication.translate("Form", u"Create Tree", None))
        self.bt_export_html.setText(QCoreApplication.translate("Form", u"Export HTML", None))
        self.bt_export_html_tabs.setText(QCoreApplication.translate("Form", u"Export Full HTML (Tabs)", None))
    # retranslateUi
