...
class Signals(DialogSignals):
    edit_class_requested = Signal(str,BsddClass) #Classtype (Class|Material|GroupOfProperties|AlternativeUse),Class
    new_class_requested = Signal(str,BsddClass)  #Classtype (Class|Material|GroupOfProperties|AlternativeUse),Parent
